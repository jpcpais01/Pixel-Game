...
// Usage: npx tsx scripts/sheet.ts [outDir] [scale] [wizard|void|pyro|warrior|jade|paladin|jedi|sith|fighter|monk|alchemist|witch|chem|archer|storm]
...
const hero = arg === 'archer' || arg === 'storm' ? 'archer' : arg === 'alchemist' || arg === 'witch' || arg === 'chem' ? 'alchemist' : arg === 'fighter' || arg === 'monk' ? 'fighter' : arg === 'warrior' || arg === 'jade' ? 'warrior' : arg === 'paladin' ? 'paladin' : arg === 'jedi' || arg === 'sith' ? 'jedi' : 'wizard';
