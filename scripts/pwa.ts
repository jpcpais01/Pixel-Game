...
self.addEventListener('activate', (e) => {
  ...
  e.waitUntil(
    caches.keys()
      .then((keys) => Promise.all(keys.filter((k) => k !== CACHE && /^(myths|everlands|pixel-battle)-/.test(k)).map((k) => caches.delete(k))))
