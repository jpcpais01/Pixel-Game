...
export class Wizard {
  ...
  private sync(): void {
    ...
    this.staffLight.intensity = (0.55 + t.glow * 0.9) * flicker * (this.casting ? 1.35 : 1);
    this.staffLight.radius = this.casting ? 80 : 58;
    this.halo.setPosition(t.x, t.y).setDepth(ry + 0.2).setAlpha(0.35 + t.glow * 0.4).setScale(this.casting ? 0.75 : 0.5);
  }
}
